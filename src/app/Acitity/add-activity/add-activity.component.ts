...
import { Activities, ServiceMaster, AdmVendor, Registration } from 'src/app/Class';
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  OnSubmit(): void {
    ...
    // this.acitivities.admVendor.AdmVendorId=3;
  // Trim whitespace from input fields
  this.acitivities.Name = this.activities.Name?.trim();
  ...
  this.acitivities.Country = "Canada";
    ...
    console.log(" Add Acitivities Are :-", this.acitivities);
    this.service.AddActivities(this.acitivities).subscribe(result => {
      // console.log(" Add Acitivities Are :-",result);
      
      if (result > 0) {
        const formData = new FormData();
        formData.append('uploadedImage', this.filesToUpload[0], this.filesToUpload[0].name);
        this.service.SaveActivitiesImage(formData, result).subscribe(() => {
          Swal.fire({
            title: 'Success!',
