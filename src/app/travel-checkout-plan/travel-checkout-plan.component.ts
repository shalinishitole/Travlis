...
import { AdmSubscription, PurchasePlan, HotelTrsDetail, TravelTrsDetail } from '../Class';
import { WebService } from '../Service';

@Component({
  selector: 'app-travel-checkout-plan',
  templateUrl: './travel-checkout-plan.component.html',
  styleUrls: ['./travel-checkout-plan.component.scss']
})
export class TravelCheckoutPlanComponent {
  ...
  constructor(private router: Router,
    ...
    private initConfig(): void {
      ...
      this.payPalConfig = {
        ...
        this.transactionDetail.TravelBookTrsId=  parseInt(data.id)
